            ...
            <div>
                <div className="container-fluid main-container">
                    <div className="row animated fadeInUp" data-animation="fadeInUp-fadeOutDown">
                        <div id="main-post" className="col-xs-10 col-md-8 col-md-offset-2 col-xs-offset-1 main-content">
                            ...
                            {!feature_img || !feature_img.length > 0 ? '' : <div className="post-picture-wrapper">
                                <img src={feature_img} alt="feature img 500" height="400" width="400" />
                            </div>}
                            ...
                            <div>
                                <div className="post-tags">
                                    <a className="tag" href="/">Donate Now</a>
                                </div>
                            </div>
                    ...
                    <div className="post-metadata-bar" data-page="post-metadata-bar">
                        <div className="flex-container is-inView inViewNone" data-behavior="animated-metadata">

            ...
            <div id="main-post" className="col-xs-10 col-md-8 col-md-offset-2 col-xs-offset-1 main-content">
              ...
              <form className="editor-form main-editor" autoComplete="off" >
                ...
                <div className="form-group">
                  ...
                  <div />
                  {' '}
                  <textarea value={description} name='description' onChange={this.handleChange} placeholder="Description" style={mystyle} />
                </div>
                ...
                <div className="form-group">
                  ...
                  <select name="imgSrc"
                    ...
                    <option value='https://bsmedia.business-standard.com/_media/bs/img/article/2020-09/30/full/1601405150-2084.jpg?im=Resize,width=640'>Pic1</option>
                    <option value='http://www.ngo.in/wp-content/uploads/2010/09/image_thumb30.png'>Pic2</option>
